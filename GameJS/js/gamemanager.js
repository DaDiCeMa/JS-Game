let GameManager = {
  ...
  setFight: function() {
    ...
    let enemy01 = new Enemy("Chogall", 200, 0, 150, 80, 150);
    let enemy02 = new Enemy("Alegix", 190, 0, 130, 60, 65);
    let enemy03 = new Enemy("Shivar", 170, 190, 112, 130, 162);
    let enemy04 = new Enemy("Malfurion", 170, 190, 112, 130, 162);
    let enemy05 = new Enemy("Shaman", 170, 190, 112, 130, 162);
